...
export default function FaqPage() {
  return <>
    <section className="faq-hero" aria-labelledby="faq-heading"><div className="container faq-hero__grid"><div><p className="eyebrow eyebrow--light">Before you attend</p><VisualMarker name="conversation" label="Questions answered" /><h1 id="faq-heading">Questions before you go?</h1></div><div><p>Short answers about the valuation, what to bring and your options.</p><Link className="text-link text-link--light" href="/events">Find an event <span aria-hidden="true">→</span></Link></div></div></section>
