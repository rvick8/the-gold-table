...
export const events: GoldTableEvent[] = [
  {
    ...
    image: "/images/gold-table-valuation-hero-branded.png", imageAlt: "A Gold Table valuer examining jewellery with a customer at a local venue", featured: true,
  },
  {
    ...
    accessibilityNotes: "Level entrance; please contact us if you have particular access needs.", parkingNotes: "Complimentary on-site parking is expected; confirmation required.", transportNotes: "Local bus connections serve Northwood town centre.", image: "/images/gold-table-valuation-hero-branded.png", imageAlt: "A Gold Table valuer examining jewellery with a customer at a local venue", featured: true,
  },
  {
  ...
  },
  {
    ...
    accessibilityNotes: "Step-free access throughout.", parkingNotes: "Small on-site car park and nearby street parking.", transportNotes: "Several local bus routes stop nearby.", image: "/images/gold-table-valuation-hero-branded.png", imageAlt: "A Gold Table valuer examining jewellery with a customer at a local venue", featured: false,
  },
  {
    ...
    image: "/images/gold-table-valuation-hero-branded.png", imageAlt: "A Gold Table valuer examining jewellery with a customer at a local venue", featured: false,
  },
  {
    ...
    image: "/images/gold-table-valuation-hero-branded.png", imageAlt: "A Gold Table valuer examining jewellery with a customer at a local venue", featured: false, noIndexWhenPast: true,
  },
];
